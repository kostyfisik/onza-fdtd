...
set output '| ps2pdf - 2D_amd.pdf'

plot "2D_test_performance.txt" u 1:2 t "Stencil" w linespoints linestyle 1 axis x1y1, \
"2D_test_performance.txt" u 1:4 t "Range" w linespoints linestyle 2 axis x1y1, \
"2D_test_performance.txt" u 1:6 t "C" w linespoints linestyle 3 axis x1y1, \
"2D_test_performance.txt" u 1:8 t "Fortran" w linespoints linestyle 4 axis x1y1
