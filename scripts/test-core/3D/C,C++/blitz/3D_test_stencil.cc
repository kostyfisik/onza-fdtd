...
void UpdateFields3DStencil(blitz::Range i, blitz::Range j, blitz::Range k) {
  ...
  }
  {
    ...
    blitz::Array<double, 3> tmpkHz = (data1(kHz, i, j1, k1));
    blitz::Array<double, 3> tmpkHy = (data1(kHy, i, j1, k1));
  ...
  }
  {
    ...
    blitz::Array<double, 3> tmpkHx = (data1(kHx, i1, j, k1));
    blitz::Array<double, 3> tmpkHz = (data1(kHz, i1, j, k1));
  ...
  }
  {
    ...
    blitz::Array<double, 3> tmpkHy = (data1(kHy, i1, j1, k));
    blitz::Array<double, 3> tmpkHx = (data1(kHx, i1, j1, k));
...
double UsingStencils(int length_x, int length_y, int length_z,
  ...
  for (int o = 0; o < repeats; ++o) {
    ...
    data1(kHx, i, j, k) = initial;
    data1(kHy, i, j, k) = initial;
    data1(kHz, i, j, k) = initial;
    data1(kEx, i, j, k) = initial;
    data1(kEy, i, j, k) = initial;
    data1(kEz, i, j, k) = initial;
    start = MPI_Wtime();
